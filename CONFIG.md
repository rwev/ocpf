...
## Objective
Grow capital over the medium-to-long term by investing in high-quality US equities with strong growth characteristics. Prioritize companies with durable competitive advantages, healthy financials, and secular tailwinds. Manage risk through diversification and position sizing.
...
- **Circuit Breaker — Hard Stop:** At -25% drawdown from HWM, liquidate all positions to cash. No new buys until drawdown recovers above -15% (i.e., portfolio recovers to within 15% of HWM)
